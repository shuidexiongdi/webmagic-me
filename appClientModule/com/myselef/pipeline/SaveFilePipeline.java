...
public class SaveFilePipeline extends FilePersistentBase implements Pipeline {
	
	 private Logger logger = LoggerFactory.getLogger(getClass());
	 
	 public SaveFilePipeline(String path) {
		 setPath(path);
	 }
...
//		ResultItems2Foods.meituanFoods(resultItems);
        try {
